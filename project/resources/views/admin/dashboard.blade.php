...
<div class="content-area">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg4">
                <div class="left">
                    ...
                    <a href="{{route('admin-import-index')}}" class="link">{{ __('View All') }}</a>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box3">
                        <p>{{ App\Models\User::where('is_vendor',2)->where( 'created_at', '>', Carbon\Carbon::now()->subDays(30))->get()->count()  }}</p>
                </div>
                <div class="c-info-box-content">
    ...
    <div class="row row-cards-one">
            ...
            <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="card">
                            <h5 class="card-header">{{ __('Recent Vendor(s)') }}</h5>
                            <div class="card-body">
                                ...
                                <div class="my-table-responsiv">
                                    <table class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            @foreach(App\Models\User::where('is_vendor',2)->orderBy('id','desc')->take(5)->get() as $data)
                                            <tr>
                                                <td>{{ $data->email }}</td>
                                    ...
                                    <table id="poproducts" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <td>{{ $data->category->name }}
                                                ...
                                                <td>
                                                    <div class="action-list"><a href="{{ route('admin-import-edit',$data->id) }}"><i
                                                                class="fas fa-eye"></i> {{ __('Details') }}</a>
                                                    </div>
                                                </td>
                                            </tr>
