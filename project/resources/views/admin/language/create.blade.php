                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang447" placeholder=" Products"
                            required="" value=" Products">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang448" placeholder="Add Product"
                            required="" value="Add Product">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang449" placeholder="All Products"
                            required="" value="All Products">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang469" placeholder="Total Services!"
                            required="" value="Total Services!">
                        </div>
                      </div>
