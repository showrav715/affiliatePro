 ...
 {{-- VENDOR PANEL STARTS --}}
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang447" placeholder="Products" required="" value="{{ $lang->lang447 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang448" placeholder="Add Product" required="" value="{{ $lang->lang448 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang449" placeholder="All Products" required="" value="{{ $lang->lang449 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Total Services! *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang469" placeholder="Total Services!" required="" value="{{ $lang->lang469 }}">
                          </div>
                        </div>
