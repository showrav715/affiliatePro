						...
						<form id="geniusform" action="{{route('admin-import-store')}}" method="POST"
							...
							<div class="showbox">
								...
								<div class="row">
									...
									<div class="col-lg-7">
										<input type="text" class="input-field" placeholder="{{ __(" Estimated Shipping
											Time") }}" name="ship">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="input-field" name="details"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea class="input-field" name="policy"></textarea>
									</div>
								</div>
							</div>
