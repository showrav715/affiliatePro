					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('admin-import-update',$data->id)}}" method="POST"
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea name="details" class="input-field">{{$data->details}}</textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="text-editor">
										<textarea name="policy" class="input-field">{{$data->policy}}</textarea>
									</div>
								</div>
							</div>
