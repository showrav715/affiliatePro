												...
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist"
														...
														<a class="nav-link payment" data-val="paystack" data-show="no"
															...
															href="#v-pills-tab7" role="tab" aria-controls="v-pills-tab7"
															aria-selected="false">
															<div class="icon">
																<span class="radio"></span>
															</div>
														...
														<a class="nav-link payment" data-val="" data-show="no"
															...
															href="#v-pills-tab8" role="tab" aria-controls="v-pills-tab8"
															aria-selected="false">
															<div class="icon">
																<span class="radio"></span>
															</div>
														...
														<a class="nav-link payment" data-val="" data-show="yes"
															data-form="{{route('authorize.submit')}}"
															data-href="{{ route('front.load.payment',['slug1' => 'authorize','slug2' => 0]) }}"
															id="v-pills-tab9-tab" data-toggle="pill"
															href="#v-pills-tab9" role="tab" aria-controls="v-pills-tab9"
															aria-selected="false">
															<div class="icon">
																<span class="radio"></span>
															</div>
