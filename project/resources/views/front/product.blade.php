...
<section class="product-details-page">
    ...
    <div class="row">
              ...
              <div class="product-info">
                ...
                <div class="info-meta-3">
                  <ul class="meta-list">
                    ...
                    @if($gs->is_buy_now == 1)
                    <li class="addtocart">
                      <a href="{{ route('product.cart.quickadd',$productt->id) }}"><i class="icofont-cart"></i>{{
                        $langg->lang251 }}</a>
                    </li>
                    @endif
                    @endif
            ...
            <div id="product-details-tab">
              <div class="top-menu-area">
                <ul class="tab-menu">
                  ...
                  @if($gs->is_comment == 1)
                  <li><a href="#tabs-4">{{ $langg->lang95 }}(<span id="comment_count">{{ count($productt->comments)
                        }}</span>)</a></li>
                  @endif
                </ul>
              </div>
      ...
      <div class="col-lg-3">
        ...
        <div class="seller-info mt-3">
          ...
          @if( $productt->user_id != 0)
          <a href="{{ route('front.vendor',str_replace(' ', '-', $productt->user->shop_name)) }}" class="view-stor">{{
            $langg->lang249 }}</a>
          @endif
  ...
  @if($productt->category->products()->where('status','=',1)->where('id','!=',$productt->id)->count() > 0)
  <div class="trending">
    <div class="container">
      <div class="row">
