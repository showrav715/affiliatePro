...
<li>
    ...
    <ul class="collapse list-unstyled" id="affiliateprod" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-import-create') }}"><span>{{ __('Add Product') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-import-index') }}"><span>{{ __('All Products') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    <a href="{{ route('admin-prod-import') }}"><i class="fas fa-upload"></i>{{ __('Csv Product Upload') }}</a>
</li>
