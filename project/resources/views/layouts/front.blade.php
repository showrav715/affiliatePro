								...
								<div class="login-form signin-form">
									...
									<form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
										...
										<div class="form-input">
											<input type="email" name="email" value="user@gmail.com" placeholder="{{ $langg->lang173 }}"
												required="">
				        ...
				        <div class="login-area">
				          <div class="login-form signin-form">
				            ...
				            <form class="mloginform" action="{{ route('user.login.submit') }}" method="POST">
				              {{ csrf_field() }}
				              <div class="form-input">
				                <input type="email" name="email" placeholder="{{ $langg->lang173 }}" required="" value="vendor@gmail.com">
				                <i class="icofont-user-alt-5"></i>
				              </div>
				              <div class="form-input">
