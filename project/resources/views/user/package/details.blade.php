                    ...
                    <div class="account-info">
                        ...
                        <div class="pack-details">
                            ...
                            <form id="subscribe-form" class="pay-form" action="{{route('user-vendor-request-submit')}}"
                                ...
                                <div id="authorizes" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="option auth" name="cardNumber" id="acard"
                                                placeholder="{{ $langg->lang163 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="option auth" name="cardCode" id="acvv"
                                                placeholder="{{ $langg->lang807 }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="option auth" name="a_month" id="amonth"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="option auth" name="a_year" id="ayear"
                                                placeholder="{{ $langg->lang808 }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <button type="submit" id="final-btn" class="mybtn1">{{ $langg->lang426
                                            }}</button>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
    $(function ($) {
        ...
        $(document).on('submit', '#paystack-form', function (e) {
            var val = $('#sub').val();
            if (val == 0) {
                $.get('{{ route('user.paystack.check')}}?shop_name=' + $('#shop-name').val(),
