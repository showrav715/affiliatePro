...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:bulk_product_upload'], function () {
        ...
        Route::post('/product/import-check', 'Admin\ProductController@store')->name('admin-prod-checksubmit');
...
Route::prefix('user')->group(function () {
    ...
    Route::get('/stripe/notify', 'User\StripeController@notify')->name('user.stripe.notify');
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('vendor')->group(function () {
        ...
        Route::group(['middleware' => 'vendor'], function () {
            ...
            Route::post('/product/import-check', 'Vendor\ProductController@store')->name('vendor-prod-checksubmit');
            Route::post('/products/import-submit', 'Vendor\ProductController@importSubmit')->name('vendor-prod-importsubmit');
            Route::get('/products/catalog/datatables', 'Vendor\ProductController@catalogdatatables')->name('vendor-vendor-catalog-datatables');
            Route::get('/products/catalogs', 'Vendor\ProductController@catalogs')->name('vendor-vendor-catalog-index');
    ...
    // CATEGORY SECTION
    Route::get('/category/{slug1?}/{slug2?}/{childcategory?}', 'Front\CatalogController@category')->name('front.category');
...
Route::get('/queue/shedule/run', function () {
